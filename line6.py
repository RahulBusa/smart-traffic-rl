...
if __name__ == "__main__":
    ...
    MAX_CYCLES = 10  # stop after 10 cycles (adjust as needed)
    ...
    for cycle in range(1, MAX_CYCLES + 1):
        ...
        for lane in LANES:
            state = "GREEN" if lane == phase else "RED"
            print(f"Lane {lane}: {state} ({green if state=='GREEN' else 0}s)")
        ...
        # Wait for green duration before next cycle
        time.sleep(green)
